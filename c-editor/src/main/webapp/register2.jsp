            ...
            <div class="col-lg-6">
              <div class="info d-flex align-items-center">
                <div class="content">
                  ...
                  <p>Teacher registration<a href="register3.jsp">Student registration</a></p>
                  <p>Register by mobile number or Register by <a href="register1.jsp">email</a></p>
                </div>
              </div>
            </div>
            <!-- Form Panel    -->
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><small>Already have an account? </small><a href="login2.jsp" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
