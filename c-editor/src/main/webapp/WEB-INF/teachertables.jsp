      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    ...
                    <li class="active"><a href=> <i class="icon-grid"></i>习题集 </a></li>
                        ...
                        <table class="table">
                          ...
                          <c:forEach items="${TopicList }" var="topic">
                            <tr>
                              ...
                              <td>${topic.title }</td>
                              <td>${topic.time }</td>
                              <td><a href="/c-editor/editor.jsp?topic=${topic.id }&topic_set=${topic.topic_set}" target="_blank">查看习题</a></td>
                              <td><a href="detail?topic_id=${topic.id }">查看学生完成情况</a></td>
                            </tr>
                           </c:forEach>
