      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
                    <li><a href="index.html"> <i class="icon-screen"></i>编译器 </a></li><!-- 如何返回index -->
                    <li class="active"><a href="teachergetAllTopicSet"> <i class="icon-grid"></i>习题集</a></li>
                      ...
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <c:forEach items="${DetailList }" var="detail"  varStatus="loop">
                            <tr>
                              <th scope="row">${param.topic_id }</th>
                              <td>${UserList[loop.count-1].username}</td>
                              <td>${UserList[loop.count-1].classes}</td>
                              <td>${detail.time }</td>
                              <td>${detail.user_score }</td>
                              <td><a href="/c-editor/viewEditor.jsp?topic_id=${param.topic_id }&user_id=${UserList[loop.count-1].id}" target="_blank">查看代码</a></td>
                            </tr>
                           </c:forEach>
